...
CREATE OR REPLACE TABLE `lt-dia-lake-sbx`.daves_dataset.test_sap_konp_delta (

  operation_id INT64 OPTIONS(description='*** NEW ADD May 25, 2023 *** [0,1,2,3] from daves_dataset.fn_operation_to_int(operation)'),
  att_timestamp TIMESTAMP OPTIONS(description='*** NEW ADD May 24, 2023 *** Attunity Timestamp field & Partition'),
...
PARTITION BY RANGE_BUCKET(operation_id, GENERATE_ARRAY(0, 5, 1)) -- 11 partitions
